...
{
    // for simplicity sake it simulate a data layer
    // this will be repeated in every project also only for simplicity sake.
    // Be aware that this repetition is not a good practice !
